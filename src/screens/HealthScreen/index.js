...
const HealthScreen = ({ item }) => {
  ...
  <View style={styles.header}>
    <Text style={styles.headerText}> Health & Fitness</Text>
  </View>
</View>
      <View style={{ flexDirection: 'row', marginBottom: 10 }}>
        {/* Button 1 with icon and text Health & Fitness*/}
        <Button
          icon={
            <FontAwesome6 
    ...
    zIndex: 1,}}>
            ...
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1556833232-52da3e4bd5d8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHdvbWVuJTIwYWxvbmV8ZW58MHx8MHx8fDA%3D' }}
    ...
    fontWeight: "bold",
    marginTop:11,
    marginLeft:-48}}>Health And Fitness Masterclass </Text>
...
<View style={{ flexDirection: "row", justifyContent: "space-between",marginRight:80 }}>
  <Text style={{ marginRight: 20, marginTop: 5, color: "grey", fontSize: 11 }}>
    <FontAwesome name="user" size={14} color="#385a7c" /> Jessic
  </Text>
  <Text style={{ marginLeft: -5, marginTop:5, color: "grey", fontSize: 11 }}>
    <FontAwesome name="calendar" size={11} color="#f97171" /> 1 hour
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 10,marginRight:95 }}>
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Text style={{ marginLeft: 5, marginRight: 15, color: "#50c878", fontSize: 11 }}>
                  Free
                </Text>
