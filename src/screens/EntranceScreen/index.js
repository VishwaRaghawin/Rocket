...
>
      <Text style ={{marginRight: 270,marginTop: 20,fontWeight:'bold',fontSize:18}}>Entrance Quiz</Text>
       <Text style ={{marginRight: 280,fontSize:13,color:'grey',marginTop:2}}>New Login Page</Text> 
      ...
      borderRadius: 36,
      padding: 12}} />
          <Text style={styles.text}>  75.0</Text>
        </View>
        
        <View style={styles.iconRow}>
        <Entypo name="bar-graph" size={15} color="grey" style={{marginLeft:65,backgroundColor: 'lightgrey',
      borderRadius: 36,
      padding: 12}} />
          <Text style={{marginRight:40,fontWeight:'bold'}}>    30</Text>
