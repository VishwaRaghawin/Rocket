...
>
      <Text style ={{marginRight: 305,marginTop: 20,fontWeight:'bold',fontSize:18}}>Final Quiz</Text>
       <Text style ={{marginRight: 250,fontSize:13,color:'grey',marginTop:2}}>Learn Linux in 5 Days </Text> 
      ...
      borderRadius: 36,
      padding: 12}} />
          <Text style={{marginRight:40,fontWeight:'bold'}}>     20</Text>
