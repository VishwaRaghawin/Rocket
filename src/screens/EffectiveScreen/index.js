  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Overview Overview</Text>
      </View>
      <ScrollView
  contentContainerStyle={styles.scrollViewContainer}
  showsVerticalScrollIndicator={false}
>
      <Text style ={{marginRight: 192,marginTop: 20,fontWeight:'bold',fontSize:18}}>Effective Time Management</Text>
      <View style={styles.starContainer}>
        ...
        <Text style={{fontWeight:'bold',fontSize:18,marginTop:20}}>Overview Overview</Text>
        {/* Text below image */}
...
export default  EffectiveScreen ;
