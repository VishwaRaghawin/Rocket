...
const  DesignScreen = ({ item }) => {
  ...
  <View style={styles.header}>
    ...
    zIndex: 1,}}>
              ...
              <Text style={{ color: "#454545", marginLeft: 5, fontSize: 10 }}>3.5</Text>
            </View>

            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1588190437916-425872ddf591?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OTJ8fHdvbWVuJTIwYWxvbmV8ZW58MHx8MHx8fDA%3D' }}
...
<View style={{ flexDirection: "row", justifyContent: "space-between",marginRight:80 }}>
  <Text style={{ marginRight: 20, marginTop: 5, color: "grey", fontSize: 11 }}>
    <FontAwesome name="user" size={14} color="#385a7c" /> Linda
  </Text>
  <Text style={{ marginLeft: -5, marginTop:5, color: "grey", fontSize: 11 }}>
    <FontAwesome name="calendar" size={11} color="#f97171" /> 1:00 Hours
  </Text>
</View>

            <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 10,marginLeft:-100 }}>
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Text style={{  marginRight: 10, color: "#50c878", fontSize: 11 }}>
                 $10 USD
                </Text>
