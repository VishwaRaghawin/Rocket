    ...
    return (
      ...
      <View style={{ flex: 1 }}>
        ...
        <Image
          ...
          <Text style={{ marginLeft: 10, fontSize: 15,fontWeight:'bold' }}>Before Starting the Course</Text>
        </View>
          ...
          <View style={{ padding: 20, backgroundColor: 'white', borderRadius: 10, marginTop: 10 ,width:'90%',marginLeft:21}}>
            <TouchableOpacity onPress={() => navigation.navigate('product')}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
                ...
                />
                <Text style={{ marginLeft: 10, fontSize: 15,fontWeight:'bold' }}>What is a Product?</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('product')}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
                <Image
                  ...
                  style={{ width: 70, height: 70, borderRadius: 10, marginRight: 10 }}
                />
                <Text style={{ marginLeft: 10, fontSize: 15,fontWeight:'bold' }}>Demo Video</Text>
              </View>
            </TouchableOpacity>
            {/* Add more images with TouchableOpacity for touchable behavior */}
            <TouchableOpacity onPress={() => navigation.navigate('vis')}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
                <Image
                  source={require('../../../assets/image/67.png')}
                  style={{ width: 70, height: 70, borderRadius: 10, marginRight: 10 }}
                />
                <Text style={{ marginLeft: 10, fontSize: 15,fontWeight:'bold' }}>Elementary Quiz</Text>
              </View>
            </TouchableOpacity>
        ...
        <Image
          ...
          <Text style={{ marginLeft: 10, fontSize: 15,fontWeight:'bold' }}>Essentials</Text>
        </View>
        <Collapsible collapsed={isCollapsed}>
          <View style={{ padding: 20, backgroundColor: 'white', borderRadius: 10, marginTop: 10 ,width:'90%',marginLeft:21}}>
            <TouchableOpacity onPress={() => navigation.navigate('product')}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
                <Image
                  ...
                  style={{ width: 70, height: 70, borderRadius: 10, marginRight: 10 }}
                />
                <Text style={{ marginLeft: 10, fontSize: 15,fontWeight:'bold' }}>Welcome!!</Text>
              </View>
            </TouchableOpacity>
         ...
         <View style={styles.cardContent}>
           ...
           <View style={styles.rightContent}>
             ...
             <View style={styles.rowContainer}>
               <Text style={styles.dateText}>26 Jun 2023</Text>
             </View>
        ...
        <Card style={styles.card}>
          <View style={styles.cardContent}>
            <View style={styles.leftContent}>
              <Image
                source={{
                  uri: 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQUCOzak4LUplIWidy4MOzy_Pnn_rWHm80YJEHig7EDtlgQiK68',
                }}
                resizeMode="cover"
                style={styles.circularImage}
              />
            ...
            <View style={styles.rightContent}>
              <Title style={styles.cardTitle}>Elementary Quiz</Title>
              <View style={styles.rowContainer}>
                <Text style={styles.dateText}>28 Jun 2023</Text>
              </View>
...
const FourthRoute = () => (
  ...
  <View style={styles.content}>
    <Image
      ...
      style={styles.image}
    />
    <Text style={{fontSize:21,fontWeight:'bold'}}>No Noticeboards!</Text>
...
const  FifthRoute = () => (
  ...
  <View style={styles.content}>
    ...
    />
    <Text style={{fontSize:21,fontWeight:'bold'}}>No Questions</Text>
  ...
  >
    <FontAwesome5 name="chevron-left" size={20} color='black' />
          ...
          <Text style={{ fontSize: 20, color: "black", marginTop: 28,textAlign:'center',marginLeft:45 }}>Web Design for Beginners</Text>
        </View>
