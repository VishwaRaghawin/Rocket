...
>
        ...
        <View style={styles.circleImage}>
          {/* Image goes here */}
          <Text style={{fontWeight:'bold',fontSize:22}}>80.0</Text>
          <Text style={{color:'grey',fontSize:13}}>Your Grade</Text>
        </View>
        
        {/* Text below image */}
        <Text style={{fontSize:20,fontWeight:'bold',marginTop:30}}>You Passed the Quiz</Text>
        <Text style={{color:'grey',marginTop:2,fontSize:12}}>Congratulations!You passed the quiz Successfully.</Text>
      ...
      borderRadius: 36,
      padding: 12}} />
          <Text style={{marginRight:40,fontWeight:'bold'}}> 80.0</Text>
      ...
      borderRadius: 36,
      padding: 12}} />
          <Text style={{color:'#50c878',fontWeight:'bold'}}> Passed</Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.threeDotsButton}   onPress={() => navigation.navigate('result')}>
          <Text style={{
